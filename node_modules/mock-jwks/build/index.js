...
var createJWKSMock = function (jwksOrigin, jwksPath) {
    ...
    var JWKS = tools_1.createJWKS(__assign(__assign({}, keypair), { jwksOrigin: jwksOrigin }));
    var jwksUrlInterceptor;
    return {
        start: function () {
            jwksUrlInterceptor = nock_1["default"](jwksOrigin).get(jwksPath);
        ...
        token: function (token) {
            ...
            return tools_1.signJwt(keypair.privateKey, token, this.kid());
        }
    };
};
